...
class RegisterController extends Controller
{
    public function store(Request $request)
    {
        ...
        $validate = $request->validate([
            ...
            'previous_school' => 'required|string|max:50',
            'hobbi' => 'required|string|max:50',
            'achievement' => 'required|string|max:50',
            'father_name' => 'required|string|max:50',
            'place_of_birth_father' => 'required|string|max:50',
            'date_of_birth_father' => 'required|date',
            'mother_name' => 'required|string|max:50',
            'place_of_birth_mother' => 'required|string|max:50',
            'date_of_birth_mother' => 'required|date',
            'number_of_siblings' => 'required|numeric',
            'phone_parent' => 'required|numeric|digits:12',
            'email_parent' => 'required|email:rfc,dns',
        ...
        try {
            ...
            DB::rollBack();
            return Inertia::render('Register')->with('error', 'Data gagal disimpan');
