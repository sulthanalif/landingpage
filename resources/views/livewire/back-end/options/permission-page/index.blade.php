...
<div>
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between items-center py-3">
            <h3 class="m-0 font-weight-bold text-primary">Permissions</h3>
                    ...
                    <tbody>
                        @forelse ($permissions as $permission)
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-sm btn-primary" wire:click="edit({{ $permission->id }})" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-danger" wire:click='modalDelete({{ $permission->id }})' data-toggle="modal" data-target="#modalDelete"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
