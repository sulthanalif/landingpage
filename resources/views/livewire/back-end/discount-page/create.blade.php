<x-drawer wire:model="drawer" title="{{ $this->recordId != null ? 'Detail' : 'Create' }} Discount" right separator with-close-button close-on-escape class="w-full lg:w-1/2 sm:w-1/2">
